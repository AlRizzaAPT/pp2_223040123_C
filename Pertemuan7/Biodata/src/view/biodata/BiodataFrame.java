...
public class BiodataFrame extends JFrame {
    ...
    public BiodataFrame(BiodataDao biodataDao) {
        ...
        labelJurusan.setBounds(15, 140, 150, 20);

        textFieldJurusan = new JTextField();
        textFieldJurusan.setBounds(15, 160, 250, 30);

        JLabel labelAlamat = new JLabel("Alamat:");
        labelAlamat.setBounds(15, 190, 150, 20);

        textFieldAlamat = new JTextField();
        textFieldAlamat.setBounds(15, 210, 250, 30);

        JButton buttonSave = new JButton("Simpan");
        buttonSave.setBounds(15, 250, 100, 40);

        JButton buttonUpdate = new JButton("Update");
        buttonUpdate.setBounds(120, 250, 100, 40);

        JButton buttonDelete = new JButton("Delete");
        buttonDelete.setBounds(225, 250, 100, 40);
    ...
    public String getJurusan() {
        return textFieldJurusan.getText();
    }
